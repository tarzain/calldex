...
/* eslint-disable react-hooks/immutability -- Rive state-machine inputs are mutable handles by design. */
...
// Delays Rive initialization by one frame so React Strict Mode's immediate
// throw-away mount never starts a duplicate Rive/WASM instance.
...
export const Persona: FC<PersonaProps> = memo(
  ({
    ...
    // Delay initialisation by one frame to skip Strict Mode's throw-away mount.
